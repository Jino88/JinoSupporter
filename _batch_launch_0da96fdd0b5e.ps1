...
$promptPath = 'D:\000. MyWorks\005. Program\Repository\JinoSupporter\_batch_prompt_0da96fdd0b5e.txt'
$scriptPath = 'D:\000. MyWorks\005. Program\Repository\JinoSupporter\_batch_launch_0da96fdd0b5e.ps1'
