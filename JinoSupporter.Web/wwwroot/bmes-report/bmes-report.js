...
var e = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), t = /* @__PURE__ */ e(((e) => {
	...
	var O = he(null), k = he(null), A = he(null), j = he(null);
	function ge(e, t) {
	...
	function ve(e) {
		e.memoizedState !== null && D(j, e);
		var t = O.current, n = Hd(t, e.type);
		t !== n && (D(k, e), D(O, n));
	}
	function ye(e) {
		k.current === e && (E(O), E(k)), j.current === e && (E(j), Qf._currentValue = fe);
	}
	var be, xe;
	function Se(e) {
		if (be === void 0) try {
	...
	function yi(e, t, n, r, i, a) {
		...
		else if (typeof e == "string") o = Uf(e, n, O.current) ? 26 : e === "html" || e === "head" || e === "body" ? 27 : 5;
		else a: switch (e) {
	...
	function uo(e) {
		var t = e.alternate;
		D(F, F.current & 1), D(co, e), lo === null && (t === null || ro.current !== null || t.memoizedState !== null) && (lo = e);
	}
	function fo(e) {
	...
	function Ac(e, t, n) {
		...
		if (s ? (o = o & 1 | 2, t.flags |= 128) : o &= 1, D(F, o), oc(e, t, r, n), r = N ? ki : 0, !s && e !== null && e.flags & 128) a: for (e = t.child; e !== null;) {
	...
	function Pc(e, t, n) {
		...
		switch (t.lanes = 0, t.tag) {
			...
			case 3:
				...
				return t;
			case 26: return gc(e, t), e === null ? (n = kf(t.type, null, t.pendingProps, null)) ? t.memoizedState = n : N || (n = t.type, e = t.pendingProps, r = Bd(A.current).createElement(n), r[pt] = t, r[mt] = e, Pd(r, n, e), Et(r), t.stateNode = r) : t.memoizedState = kf(t.type, e.memoizedProps, t.pendingProps, e.memoizedState), null;
			case 27: return ve(t), e === null && N && (r = t.stateNode = ff(t.type, t.pendingProps, A.current), Bi = t, Hi = !0, i = M, Zd(t.type) ? (lf = i, M = cf(r.firstChild)) : M = i), oc(e, t, t.pendingProps.children, n), gc(e, t), e === null && (t.flags |= 4194304), t.child;
	...
	function Bc(e, t, n) {
		...
		switch (Ri(t), t.tag) {
			...
			case 27:
				if (ye(t), n = A.current, i = t.type, e !== null && t.stateNode != null) e.memoizedProps !== r && Fc(t);
				else {
					if (!r) {
						if (t.stateNode === null) throw Error(s(166));
						return H(t), null;
					}
					e = O.current, qi(t) ? Gi(t, e) : (e = ff(i, r, n), t.stateNode = e, Fc(t));
				}
				return H(t), null;
			case 5:
	...
	function Vc(e, t) {
		switch (Ri(t), t.tag) {
			...
			case 22:
			case 23: return ho(t), so(), e !== null && E(Ca), e = t.flags, e & 65536 ? (t.flags = e & -65537 | 128, t) : null;
	...
	status;
	constructor(e, t, n) {
		super(t), this.kind = e, this.status = n, this.name = "ReportLoadError";
	}
}, m = (e) => typeof e == "object" && !!e && !Array.isArray(e);
function h(e) {
	if (!m(e)) throw new p("invalid-data", "리포트 응답이 JSON 객체가 아닙니다.");
	if (e.contractId !== "jinosupporter.bmes-report") throw new p("invalid-data", "지원하지 않는 리포트 계약입니다.");
	if (e.schemaVersion !== "1.0.0") throw new p("unsupported-schema", `지원하지 않는 리포트 스키마입니다. 서버 ${String(e.schemaVersion)}, 뷰어 ${d}`);
	if (!m(e.viewerDefaults) || !m(e.status) || !m(e.tabs)) throw new p("invalid-data", "리포트 공통 필드가 누락되었습니다.");
	let t = Object.keys(e.tabs).sort(), n = [...f].sort();
	if (t.length !== n.length || t.some((e, t) => e !== n[t])) throw new p("invalid-data", "8개 탭 계약이 일치하지 않습니다.");
	for (let t of f) {
		let n = e.tabs[t];
		if (!m(n) || !m(n.status) || !("data" in n)) throw new p("invalid-data", `${t} 탭 데이터가 올바르지 않습니다.`);
	}
	return e;
}
async function g(e, t, n = fetch) {
	let r;
	try {
		r = await n(e, {
			method: "GET",
		...
		throw e instanceof DOMException && e.name === "AbortError" ? e : new p("network", "리포트 서버에 연결할 수 없습니다.");
	}
	if (!r.ok) throw r.status === 401 ? new p("unauthorized", "로그인 세션이 만료되었습니다.", 401) : r.status === 403 ? new p("forbidden", "이 리포트를 볼 권한이 없습니다.", 403) : r.status === 404 || r.status === 410 ? new p("expired", "리포트 링크가 만료되었거나 존재하지 않습니다.", r.status) : new p("network", `리포트를 불러오지 못했습니다. (HTTP ${r.status})`, r.status);
	let i;
	try {
		i = await r.json();
	} catch {
		throw new p("invalid-data", "리포트 JSON을 읽을 수 없습니다.");
	}
	return h(i);
}
//#endregion
//#region src/logic.ts
var _ = "jinosupporter.bmes-report.viewer.v1", v = (e) => ({
	minimumPpm: ee(e.minimumPpm, 500),
	dateColumnLimit: S(e.dateColumnLimit, 7),
	weekColumnLimit: S(e.weekColumnLimit, 4),
	monthColumnLimit: S(e.monthColumnLimit, 3)
});
function y(e, t) {
	let n = v(t);
	if (!e) return n;
	try {
		let t = JSON.parse(e);
		return {
			minimumPpm: ee(Number(t.minimumPpm), n.minimumPpm),
			dateColumnLimit: S(Number(t.dateColumnLimit), n.dateColumnLimit),
			weekColumnLimit: S(Number(t.weekColumnLimit), n.weekColumnLimit),
			monthColumnLimit: S(Number(t.monthColumnLimit), n.monthColumnLimit)
		};
	} catch {
		return n;
	}
...
function b(e) {
	if (typeof window > "u") return v(e);
	try {
		return y(window.localStorage.getItem(_), e);
	} catch {
		return v(e);
	}
}
...
function C(e) {
	return f.includes(e) ? e : "daily";
}
function te(e, t, n = !1) {
	let r = [...e].sort((e, t) => e.sortOrder - t.sortOrder);
	if (n) return r;
	let i = (e) => e === "date" ? t.dateColumnLimit : e === "week" ? t.weekColumnLimit : t.monthColumnLimit;
	return [
		"date",
		"week",
		"month"
	].flatMap((e) => {
		let t = r.filter((t) => t.kind === e), n = i(e);
		return n === 0 ? [] : t.slice(Math.max(0, t.length - n));
	});
}
function ne(e, t, n) {
	return t ? e.filter((e) => {
		if (e.isTotal) return !0;
		let r = e.ppmByPeriod[t];
		return r != null && r >= n;
	}) : e;
}
function re(e, t) {
	let n = e.filter((e) => !e.isTotal);
	return Object.fromEntries(t.map((e) => {
		let t = n.map((t) => t.ppmByPeriod[e.key]).filter((e) => typeof e == "number" && Number.isFinite(e));
		return [e.key, t.length === 0 ? null : t.reduce((e, t) => e + t, 0)];
	}));
}
function ie(e, t) {
	return t.view.sourceTab === "fcost" ? e.tabs.fcost.data?.dataset ?? null : null;
}
//#endregion
//#region src/format.ts
var ae = new Intl.NumberFormat("en-US", {
	minimumFractionDigits: 0,
	maximumFractionDigits: 0
}), oe = new Intl.NumberFormat("en-US", {
	minimumFractionDigits: 2,
	maximumFractionDigits: 2
}), se = new Intl.NumberFormat("en-US", {
	style: "currency",
	currency: "USD",
	currencyDisplay: "narrowSymbol",
	minimumFractionDigits: 0,
	maximumFractionDigits: 0
}), ce = new Intl.NumberFormat("en-US", {
	style: "currency",
	currency: "USD",
	currencyDisplay: "narrowSymbol",
	minimumFractionDigits: 2,
	maximumFractionDigits: 2
}), le = (e) => typeof e == "number" && Number.isFinite(e);
function ue(e, t = 0) {
	let n = 10 ** t, r = e * n, i = Math.floor(r), a = r - i, o = 2 ** -52 * Math.max(1, Math.abs(r)) * 4;
	return Math.abs(a - .5) <= o ? (i % 2 == 0 ? i : i + 1) / n : Math.round(r) / n;
}
var de = (e) => le(e) ? ae.format(ue(e)) : "-", w = (e) => le(e) ? ae.format(ue(e)) : "-", T = (e) => le(e) ? `${oe.format(ue(e, 2))}%` : "-", fe = (e) => le(e) ? `${oe.format(ue(e * 100, 2))}%` : "-", pe = (e, t = !1) => le(e) ? (t ? ce : se).format(ue(e, t ? 2 : 0)) : "-", me = (e) => le(e) ? `${ae.format(ue(e))} VND` : "-", he = (e) => le(e) ? oe.format(ue(e, 2)) : "-";
function E(e, t) {
	return t === "percent" ? T(e) : t === "usd" ? pe(e) : t === "ppm" ? w(e) : le(e) ? oe.format(ue(e, 2)) : "-";
}
//#endregion
...
function k({ caption: e, headers: t, children: n, className: r = "" }) {
	return /* @__PURE__ */ (0, O.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, O.jsxs)("table", {
			className: `report-table ${r}`.trim(),
			children: [
				/* @__PURE__ */ (0, O.jsx)("caption", { children: e }),
				/* @__PURE__ */ (0, O.jsx)("thead", { children: /* @__PURE__ */ (0, O.jsx)("tr", { children: t.map((e, t) => /* @__PURE__ */ (0, O.jsx)("th", {
					scope: "col",
					children: e
				}, t)) }) }),
				/* @__PURE__ */ (0, O.jsx)("tbody", { children: n })
			]
		})
	});
}
function A({ message: e = "표시할 데이터가 없습니다." }) {
...
function j({ title: e, count: t, children: n }) {
	return /* @__PURE__ */ (0, O.jsxs)("section", {
		className: "report-section",
		children: [/* @__PURE__ */ (0, O.jsxs)("div", {
			className: "section-heading",
			children: [/* @__PURE__ */ (0, O.jsx)("h2", { children: e }), t !== void 0 && /* @__PURE__ */ (0, O.jsx)("span", {
...
function ge(e) {
	return { paddingInlineStart: `${Math.max(0, e) * 1.1 + .7}rem` };
}
//#endregion
//#region src/tabs/CauseMonthlyTab.tsx
function _e({ data: e, preferences: t }) {
	let n = te(e.periods, t);
	return /* @__PURE__ */ (0, O.jsxs)("div", {
		className: "tab-content",
		children: [/* @__PURE__ */ (0, O.jsx)(j, {
			title: "원인 비중",
			count: e.rows.length,
			children: e.rows.length === 0 ? /* @__PURE__ */ (0, O.jsx)(A, {}) : /* @__PURE__ */ (0, O.jsx)(k, {
				caption: "모델별 원인 비중과 가중 PPM",
				headers: [
					"Model",
					"Type",
					"Process",
					...
					"Cause",
					"Share",
					...n.flatMap((e) => [`${e.header} PPM`, `${e.header} 가중 PPM`])
				],
				children: e.rows.map((e) => /* @__PURE__ */ (0, O.jsxs)("tr", {
					className: e.isSubtotal ? "total-row" : "",
					children: [
						/* @__PURE__ */ (0, O.jsx)("th", {
							scope: "row",
							children: e.model
						}),
						/* @__PURE__ */ (0, O.jsx)("td", { children: e.type ?? "-" }),
						/* @__PURE__ */ (0, O.jsx)("td", { children: e.process ?? "-" }),
						/* @__PURE__ */ (0, O.jsx)("td", { children: e.ngName ?? "-" }),
						/* @__PURE__ */ (0, O.jsx)("td", {
							className: "numeric",
							children: e.number ?? "-"
						}),
						/* @__PURE__ */ (0, O.jsx)("td", { children: e.cause ?? "-" }),
						/* @__PURE__ */ (0, O.jsx)("td", {
							className: "numeric",
							children: fe(e.shareRatio)
						}),
						n.flatMap((t) => [/* @__PURE__ */ (0, O.jsx)("td", {
							className: "numeric",
							children: w(e.ppmByPeriod[t.key])
						}, `${t.key}-ppm`), /* @__PURE__ */ (0, O.jsx)("td", {
							className: "numeric",
							children: w(e.weightedPpmByPeriod[t.key])
						}, `${t.key}-weighted`)])
					]
				}, e.rowId))
			})
			...
			title: "모델 월별 PPM",
			count: e.modelMonthlyRows.length,
			children: e.modelMonthlyRows.length === 0 ? /* @__PURE__ */ (0, O.jsx)(A, {}) : /* @__PURE__ */ (0, O.jsx)(k, {
				caption: "모델별 월간 PPM",
				headers: ["Model", ...n.map((e) => `${e.header} PPM`)],
				children: e.modelMonthlyRows.map((e) => /* @__PURE__ */ (0, O.jsxs)("tr", { children: [/* @__PURE__ */ (0, O.jsx)("th", {
					scope: "row",
					children: e.model
				}), n.map((t) => /* @__PURE__ */ (0, O.jsx)("td", {
					className: "numeric",
					children: w(e.ppmByPeriod[t.key])
				}, t.key))] }, e.model))
			})
...
//#endregion
//#region src/tabs/DailyTab.tsx
function ve({ data: e, preferences: t }) {
	let n = te(e.periods, t);
	return /* @__PURE__ */ (0, O.jsxs)("div", {
		className: "tab-content",
		children: [
			/* @__PURE__ */ (0, O.jsx)(j, {
				title: "Daily 요약",
				count: e.summaryRows.length,
				children: e.summaryRows.length === 0 ? /* @__PURE__ */ (0, O.jsx)(A, {}) : /* @__PURE__ */ (0, O.jsx)(k, {
					...
					children: e.summaryRows.map((e) => /* @__PURE__ */ (0, O.jsxs)("tr", {
						className: e.level === "total" ? "total-row" : "",
						children: [
							/* @__PURE__ */ (0, O.jsx)("th", {
								scope: "row",
								style: ge(e.depth),
							...
							/* @__PURE__ */ (0, O.jsxs)("td", { children: [e.level, e.processType ? ` · ${e.processType}` : ""] }),
							n.flatMap((t) => [
								/* @__PURE__ */ (0, O.jsx)("td", {
									className: "numeric",
									children: de(e.inputByPeriod[t.key])
								}, `${e.rowId}-${t.key}-input`),
								/* @__PURE__ */ (0, O.jsx)("td", {
									className: "numeric",
									children: de(e.ngByPeriod[t.key])
								}, `${e.rowId}-${t.key}-ng`),
								/* @__PURE__ */ (0, O.jsx)("td", {
									className: "numeric",
									children: w(e.ppmByPeriod[t.key])
			...
			/* @__PURE__ */ (0, O.jsx)(j, {
				title: "모델별 불량 원인",
				count: e.modelSections.length,
				children: e.modelSections.length === 0 ? /* @__PURE__ */ (0, O.jsx)(A, {}) : e.modelSections.map((r) => {
					let i = ne(r.reasonRows, e.referenceDatePeriodKey, t.minimumPpm), a = re(i, n);
					return /* @__PURE__ */ (0, O.jsxs)("section", {
						className: "model-section",
						"aria-labelledby": `daily-model-${r.id}`,
						children: [/* @__PURE__ */ (0, O.jsxs)("div", {
							...
							}), /* @__PURE__ */ (0, O.jsxs)("span", { children: [r.lineShiftCount.toLocaleString("en-US"), " line shifts"] })]
						}), i.filter((e) => !e.isTotal).length === 0 ? /* @__PURE__ */ (0, O.jsx)(A, { message: `Minimum PPM ${w(t.minimumPpm)} 이상인 원인이 없습니다.` }) : /* @__PURE__ */ (0, O.jsxs)(k, {
							caption: `${r.modelName} 불량 원인 PPM`,
							headers: [
								"순위",
								"원인",
								"Process",
								"공정",
								"NG",
								...n.map((e) => `${e.header} PPM`)
							],
							children: [i.map((e) => /* @__PURE__ */ (0, O.jsxs)("tr", {
								className: e.isTotal ? "total-row" : "",
								children: [
									/* @__PURE__ */ (0, O.jsx)("td", {
										className: "numeric",
										children: e.rank ?? "-"
									...
									/* @__PURE__ */ (0, O.jsx)("td", { children: e.processType ?? "-" }),
									/* @__PURE__ */ (0, O.jsx)("td", { children: e.processName ?? "-" }),
									/* @__PURE__ */ (0, O.jsx)("td", { children: e.ngName ?? "-" }),
									n.map((t) => /* @__PURE__ */ (0, O.jsx)("td", {
										className: "numeric",
										children: w(e.ppmByPeriod[t.key])
							...
							}, e.rowId)), /* @__PURE__ */ (0, O.jsxs)("tr", {
								className: "visible-total-row",
								children: [
									/* @__PURE__ */ (0, O.jsx)("td", {}),
									/* @__PURE__ */ (0, O.jsx)("th", {
										scope: "row",
										colSpan: 4,
										children: "현재 필터 표시 합계"
									}),
									n.map((e) => /* @__PURE__ */ (0, O.jsx)("td", {
										className: "numeric",
										children: w(a[e.key])
									}, e.key))
								]
			...
			n.length === 0 && /* @__PURE__ */ (0, O.jsx)(A, { message: "기간 표시 개수가 모두 0입니다. 상단 필터에서 기간을 늘려 주세요." })
		]
	});
}
//#endregion
//#region src/tabs/FCostTab.tsx
function ye({ dataset: e, view: t, preferences: n }) {
	if (t.mode === "target-defect-rate") return /* @__PURE__ */ (0, O.jsx)(Se, {
		dataset: e,
		view: t,
		preferences: n
	});
	let r = te(e.periods, n, t.allPeriods);
	return /* @__PURE__ */ (0, O.jsxs)("div", {
		className: "tab-content",
		children: [
			/* @__PURE__ */ (0, O.jsxs)("p", {
				className: "view-mode-note",
				children: [t.allPeriods ? "전체 기간" : "최근 기간", " · Regular F-COST · USD"]
			}),
			/* @__PURE__ */ (0, O.jsx)(j, {
				title: "F-COST 합계",
				children: r.length === 0 ? /* @__PURE__ */ (0, O.jsx)(A, {}) : /* @__PURE__ */ (0, O.jsxs)(k, {
					caption: "F-COST 기간별 합계",
					headers: ["지표", ...r.map((e) => e.header)],
					children: [
						/* @__PURE__ */ (0, O.jsxs)("tr", { children: [/* @__PURE__ */ (0, O.jsx)("th", {
							scope: "row",
							children: "Input"
						}), r.map((t) => /* @__PURE__ */ (0, O.jsx)("td", {
							className: "numeric",
							children: de(e.totals.inputQtyByPeriod[t.key])
						}, t.key))] }),
						/* @__PURE__ */ (0, O.jsxs)("tr", { children: [/* @__PURE__ */ (0, O.jsx)("th", {
							scope: "row",
							children: "F-COST (USD)"
							...
							className: "numeric",
							children: pe(e.totals.fcostUsdByPeriod[t.key])
						}, t.key))] }),
						/* @__PURE__ */ (0, O.jsxs)("tr", { children: [/* @__PURE__ */ (0, O.jsx)("th", {
							scope: "row",
							children: "F-COST Rate"
						}), r.map((t) => /* @__PURE__ */ (0, O.jsx)("td", {
							className: "numeric",
							children: T(e.totals.ratePercentByPeriod[t.key])
						}, t.key))] })
					]
				})
			}),
			/* @__PURE__ */ (0, O.jsx)(j, {
				title: "Model / NG 추세",
				count: e.trendRows.length,
				children: e.trendRows.length === 0 ? /* @__PURE__ */ (0, O.jsx)(A, {}) : /* @__PURE__ */ (0, O.jsx)(k, {
					caption: "모델 및 NG 그룹 F-COST 추세",
					headers: [
						"Group",
						"Model",
						"NG Group",
					...
					children: e.trendRows.map((e) => /* @__PURE__ */ (0, O.jsxs)("tr", { children: [
						/* @__PURE__ */ (0, O.jsx)("td", {
							style: ge(e.depth),
							children: e.groupName
						}),
						/* @__PURE__ */ (0, O.jsx)("td", { children: e.modelName }),
						/* @__PURE__ */ (0, O.jsx)("th", {
							scope: "row",
							children: e.ngGroupKey
						}),
						r.flatMap((t) => [
							/* @__PURE__ */ (0, O.jsx)("td", {
								className: "numeric",
								children: de(e.inputQtyByPeriod[t.key])
							}, `${t.key}-input`),
							/* @__PURE__ */ (0, O.jsx)("td", {
								className: "numeric",
								children: pe(e.fcostUsdByPeriod[t.key])
							}, `${t.key}-cost`),
							/* @__PURE__ */ (0, O.jsx)("td", {
								className: "numeric",
								children: w(e.ngPpmByPeriod[t.key])
							}, `${t.key}-ppm`),
							/* @__PURE__ */ (0, O.jsx)("td", {
								className: "numeric",
								children: T(e.fcostSharePercentByPeriod[t.key])
							}, `${t.key}-share`)
						])
					] }, e.rowId))
				})
			...
			/* @__PURE__ */ (0, O.jsx)(j, {
				title: "F-COST 계층",
				count: e.hierarchyRows.length,
				children: e.hierarchyRows.length === 0 ? /* @__PURE__ */ (0, O.jsx)(A, {}) : /* @__PURE__ */ (0, O.jsx)(k, {
					caption: "Mid/Sub 계층 F-COST",
					headers: [
						"항목",
						"Group",
						"Model",
					...
					children: e.hierarchyRows.map((e) => /* @__PURE__ */ (0, O.jsxs)("tr", { children: [
						/* @__PURE__ */ (0, O.jsx)("th", {
							scope: "row",
							style: ge(e.depth),
							children: e.display
						}),
						/* @__PURE__ */ (0, O.jsx)("td", { children: e.groupName }),
						/* @__PURE__ */ (0, O.jsx)("td", { children: e.modelName }),
						/* @__PURE__ */ (0, O.jsx)("td", { children: e.ngGroupKey }),
						/* @__PURE__ */ (0, O.jsx)("td", {
							className: "numeric",
							children: e.matchedMaterialCount
						}),
						r.flatMap((t) => [
							/* @__PURE__ */ (0, O.jsx)("td", {
								className: "numeric",
							...
							/* @__PURE__ */ (0, O.jsx)("td", {
								className: "numeric",
								children: T(e.sourceRatePercentByPeriod[t.key])
							}, `${t.key}-rate`)
						])
					] }, e.rowId))
				})
			...
			/* @__PURE__ */ (0, O.jsx)(be, {
				title: "Unmapped Material",
				rows: e.unmappedMaterials,
				periods: r
			}),
			/* @__PURE__ */ (0, O.jsx)(xe, {
				dataset: e,
...
function be({ title: e, rows: t, periods: n }) {
	return /* @__PURE__ */ (0, O.jsx)(j, {
		title: e,
		count: t.length,
		children: t.length === 0 ? /* @__PURE__ */ (0, O.jsx)(A, {}) : /* @__PURE__ */ (0, O.jsx)(k, {
			caption: `${e} F-COST`,
			headers: [
				"Name",
				"Product Group",
			...
			children: t.map((e, t) => /* @__PURE__ */ (0, O.jsxs)("tr", { children: [
				/* @__PURE__ */ (0, O.jsx)("th", {
					scope: "row",
					children: e.displayName
				}),
				/* @__PURE__ */ (0, O.jsx)("td", { children: e.productGroup ?? "-" }),
				/* @__PURE__ */ (0, O.jsx)("td", { children: e.modelNo ?? "-" }),
				/* @__PURE__ */ (0, O.jsx)("td", { children: e.material ?? "-" }),
				/* @__PURE__ */ (0, O.jsx)("td", { children: e.verid ?? "-" }),
				n.flatMap((t) => [
					/* @__PURE__ */ (0, O.jsx)("td", {
						className: "numeric",
						children: de(e.inputQtyByPeriod[t.key])
			...
			] }, `${e.displayName}-${e.material ?? "none"}-${e.verid ?? "none"}-${t}`))
		})
	});
}
function xe({ dataset: e, preferences: t, allPeriods: n }) {
	let r = e.rawBreakdown;
	if (!r) return /* @__PURE__ */ (0, O.jsx)(j, {
		title: "Raw Material F-COST",
		children: /* @__PURE__ */ (0, O.jsx)(A, { message: "Raw breakdown source를 사용할 수 없습니다." })
	});
	let i = te(r.periods, t, n);
	return /* @__PURE__ */ (0, O.jsxs)(j, {
		...
		children: [
			/* @__PURE__ */ (0, O.jsxs)("dl", {
				...
				children: [/* @__PURE__ */ (0, O.jsxs)("div", { children: [/* @__PURE__ */ (0, O.jsx)("dt", { children: "Source Table" }), /* @__PURE__ */ (0, O.jsx)("dd", { children: r.sourceTable || "-" })] }), /* @__PURE__ */ (0, O.jsxs)("div", { children: [/* @__PURE__ */ (0, O.jsx)("dt", { children: "Name Source" }), /* @__PURE__ */ (0, O.jsx)("dd", { children: r.nameSource || "-" })] })]
			}),
			r.warningMessage && /* @__PURE__ */ (0, O.jsx)("p", {
				className: "inline-warning",
				role: "status",
				children: r.warningMessage
			}),
			r.exchangeRates.length > 0 && /* @__PURE__ */ (0, O.jsx)(k, {
				caption: "Raw breakdown 환율",
				headers: [
					"Period",
					"기준일",
					"KRW/USD",
				...
				children: r.exchangeRates.map((e) => /* @__PURE__ */ (0, O.jsxs)("tr", { children: [
					/* @__PURE__ */ (0, O.jsx)("th", {
						scope: "row",
						children: e.periodKey
					}),
					/* @__PURE__ */ (0, O.jsx)("td", { children: e.standardDate }),
					/* @__PURE__ */ (0, O.jsx)("td", {
						className: "numeric",
						children: he(e.krwPerUsd)
					}),
					/* @__PURE__ */ (0, O.jsx)("td", {
						className: "numeric",
						children: he(e.krwPerVnd)
					})
				] }, e.periodKey))
			}),
			r.rows.length === 0 ? /* @__PURE__ */ (0, O.jsx)(A, {}) : /* @__PURE__ */ (0, O.jsx)(k, {
				caption: "Raw material VND breakdown",
				headers: [
					"Group",
					"Model",
					"Material Code",
				...
				children: r.rows.map((e, t) => /* @__PURE__ */ (0, O.jsxs)("tr", { children: [
					/* @__PURE__ */ (0, O.jsx)("td", { children: e.groupName }),
					/* @__PURE__ */ (0, O.jsx)("td", { children: e.modelName }),
					/* @__PURE__ */ (0, O.jsx)("td", { children: e.materialCode }),
					/* @__PURE__ */ (0, O.jsx)("th", {
						scope: "row",
					...
					/* @__PURE__ */ (0, O.jsx)("td", {
						className: "numeric",
						children: me(e.totalFcostVnd)
					}),
					/* @__PURE__ */ (0, O.jsx)("td", {
						className: "numeric",
						children: e.sourceRows.toLocaleString("en-US")
					}),
					i.flatMap((t) => {
						let n = e.priceByPeriod[t.key], r = n?.unitPrice === null || n?.unitPrice === void 0 ? "-" : `${he(n.unitPrice)} ${n.currency ?? ""}${n.priceUnit ? `/${n.priceUnit}` : ""}${n.isMixed ? " (mixed)" : ""}`.trim();
						return [
							/* @__PURE__ */ (0, O.jsx)("td", {
								className: "numeric",
								children: me(e.fcostVndByPeriod[t.key])
							}, `${t.key}-cost`),
							/* @__PURE__ */ (0, O.jsx)("td", {
								className: "numeric",
								children: he(e.equivalentQtyByPeriod[t.key])
							}, `${t.key}-qty`),
							/* @__PURE__ */ (0, O.jsx)("td", {
								className: "numeric",
								children: r
							...
							/* @__PURE__ */ (0, O.jsx)("td", {
								className: "numeric",
								children: me(n?.unitPriceVnd)
							}, `${t.key}-price-vnd`)
						];
					})
				] }, `${e.groupName}-${e.modelName}-${e.materialCode}-${t}`))
			})
		]
	});
}
function Se({ dataset: e, view: t, preferences: n }) {
	let r = e.targetDefectRate, i = te(e.periods, n, t.allPeriods);
	return /* @__PURE__ */ (0, O.jsxs)("div", {
		className: "tab-content",
		children: [
			/* @__PURE__ */ (0, O.jsxs)("p", {
				className: "view-mode-note",
				children: [t.allPeriods ? "전체 기간" : "최근 기간", " · 목표 불량률"]
			}),
			/* @__PURE__ */ (0, O.jsxs)(j, {
				title: "목표 기준",
				children: [/* @__PURE__ */ (0, O.jsxs)("dl", {
					className: "metric-meta",
					children: [/* @__PURE__ */ (0, O.jsxs)("div", { children: [/* @__PURE__ */ (0, O.jsx)("dt", { children: "기본 Baseline" }), /* @__PURE__ */ (0, O.jsx)("dd", { children: T(r.defaultBaselineRatePercent) })] }), r.defaultTargetRatePercent.map((e, t) => /* @__PURE__ */ (0, O.jsxs)("div", { children: [/* @__PURE__ */ (0, O.jsxs)("dt", { children: ["기본 Target ", t + 1] }), /* @__PURE__ */ (0, O.jsx)("dd", { children: T(e) })] }, t))]
				}), r.actionItems.length === 0 ? /* @__PURE__ */ (0, O.jsx)(A, { message: "등록된 action item이 없습니다." }) : /* @__PURE__ */ (0, O.jsx)("ol", {
					className: "action-list",
					children: r.actionItems.map((e, t) => /* @__PURE__ */ (0, O.jsx)("li", { children: e }, `${t}-${e}`))
				})]
			}),
			/* @__PURE__ */ (0, O.jsx)(j, {
				title: "목표 불량률",
				count: r.rows.length,
				children: r.rows.length === 0 ? /* @__PURE__ */ (0, O.jsx)(A, {}) : /* @__PURE__ */ (0, O.jsxs)(k, {
					caption: "모델별 목표 불량률",
					headers: [
						"Model",
						"Target PPM",
						"Achievement",
						...i.map((e) => `${e.header} Actual PPM`)
					],
					children: [/* @__PURE__ */ (0, O.jsxs)("tr", {
						className: "total-row",
						children: [
							/* @__PURE__ */ (0, O.jsx)("th", {
								scope: "row",
							...
							/* @__PURE__ */ (0, O.jsx)("td", { children: "-" }),
							/* @__PURE__ */ (0, O.jsx)("td", { children: "-" }),
							i.map((e) => /* @__PURE__ */ (0, O.jsx)("td", {
								className: "numeric",
								children: w(r.totalActualPpmByPeriod[e.key])
							}, e.key))
						]
					}), r.rows.map((e, t) => /* @__PURE__ */ (0, O.jsxs)("tr", { children: [
						/* @__PURE__ */ (0, O.jsx)("th", {
							scope: "row",
						...
						/* @__PURE__ */ (0, O.jsx)("td", {
							className: "numeric",
							children: w(e.targetPpm)
						}),
						/* @__PURE__ */ (0, O.jsx)("td", {
							className: "numeric",
							children: T(e.achievementPercent)
						}),
						i.map((t) => /* @__PURE__ */ (0, O.jsx)("td", {
							className: "numeric",
							children: w(e.actualPpmByPeriod[t.key])
						}, t.key))
					] }, `${e.modelName}-${t}`))]
				})
			})
...
//#endregion
//#region src/tabs/KpiTab.tsx
function Ce({ data: e, preferences: t }) {
	let n = te(e.periods, t);
	return /* @__PURE__ */ (0, O.jsx)("div", {
		className: "tab-content kpi-grid",
		children: e.metrics.length === 0 ? /* @__PURE__ */ (0, O.jsx)(A, {}) : e.metrics.map((e) => /* @__PURE__ */ (0, O.jsxs)(j, {
			title: e.name,
			count: e.lines.length,
			children: [/* @__PURE__ */ (0, O.jsxs)("dl", {
				className: "metric-meta",
				children: [
					/* @__PURE__ */ (0, O.jsxs)("div", { children: [/* @__PURE__ */ (0, O.jsx)("dt", { children: "Type" }), /* @__PURE__ */ (0, O.jsx)("dd", { children: e.type })] }),
					/* @__PURE__ */ (0, O.jsxs)("div", { children: [/* @__PURE__ */ (0, O.jsx)("dt", { children: "Baseline" }), /* @__PURE__ */ (0, O.jsx)("dd", { children: E(e.baselineValue, e.unit) })] }),
					/* @__PURE__ */ (0, O.jsxs)("div", { children: [/* @__PURE__ */ (0, O.jsx)("dt", { children: "Target" }), /* @__PURE__ */ (0, O.jsx)("dd", { children: E(e.targetValue, e.unit) })] })
				]
			}), e.lines.length === 0 ? /* @__PURE__ */ (0, O.jsx)(A, {}) : /* @__PURE__ */ (0, O.jsx)(k, {
				caption: `${e.name} KPI`,
				headers: [
					"지표",
					"종류",
				...
				children: e.lines.map((t, r) => /* @__PURE__ */ (0, O.jsxs)("tr", { children: [
					/* @__PURE__ */ (0, O.jsx)("th", {
						scope: "row",
						children: t.label
					}),
					/* @__PURE__ */ (0, O.jsx)("td", { children: t.kind }),
					/* @__PURE__ */ (0, O.jsx)("td", {
						className: "numeric",
						children: E(t.annualValue, t.unit)
					}),
					n.map((e) => /* @__PURE__ */ (0, O.jsx)("td", {
						className: "numeric",
						children: E(t.valuesByPeriod[e.key], t.unit)
					}, e.key))
				] }, `${e.id}-${t.kind}-${r}`))
			})]
		}, e.id))
...
//#endregion
//#region src/tabs/WeeklyTab.tsx
function we({ data: e, preferences: t }) {
	let n = te(e.periods, t);
	return /* @__PURE__ */ (0, O.jsxs)("div", {
		className: "tab-content",
		children: [
			/* @__PURE__ */ (0, O.jsx)(j, {
				title: "주간 목표",
				count: e.targetRows.length,
				children: e.targetRows.length === 0 ? /* @__PURE__ */ (0, O.jsx)(A, {}) : /* @__PURE__ */ (0, O.jsx)(k, {
					caption: "주간 목표와 달성률",
					headers: [
						"항목",
						"구분",
					...
					children: e.targetRows.map((e) => /* @__PURE__ */ (0, O.jsxs)("tr", {
						className: e.rowKind === "group" ? "total-row" : "",
						children: [
							/* @__PURE__ */ (0, O.jsx)("th", {
								scope: "row",
								style: ge(e.depth),
							...
							/* @__PURE__ */ (0, O.jsxs)("td", { children: [e.rowKind, e.isLineShift ? " · line shift" : ""] }),
							/* @__PURE__ */ (0, O.jsx)("td", {
								className: "numeric",
								children: w(e.baselinePpm)
							}),
							/* @__PURE__ */ (0, O.jsx)("td", {
								className: "numeric",
								children: w(e.targetPpm)
			...
			/* @__PURE__ */ (0, O.jsx)(j, {
				...
				count: e.summaryRows.length,
				children: e.summaryRows.length === 0 ? /* @__PURE__ */ (0, O.jsx)(A, {}) : /* @__PURE__ */ (0, O.jsx)(k, {
					caption: "Weekly 계층 PPM 요약",
					headers: [
						"항목",
						"Level / Process",
						...n.map((e) => `${e.header} PPM`)
					],
					children: e.summaryRows.map((e) => /* @__PURE__ */ (0, O.jsxs)("tr", { children: [
						/* @__PURE__ */ (0, O.jsx)("th", {
							scope: "row",
							style: ge(e.depth),
							children: e.display
			...
			/* @__PURE__ */ (0, O.jsx)(j, {
				title: "추세 시리즈",
				count: e.trendSeries.length,
				children: e.trendSeries.length === 0 ? /* @__PURE__ */ (0, O.jsx)(A, {}) : /* @__PURE__ */ (0, O.jsx)(k, {
					caption: "Weekly 추세 시리즈",
					headers: [
						"시리즈",
						"그룹",
						...n.map((e) => `${e.header} PPM`)
					],
					children: e.trendSeries.map((e) => /* @__PURE__ */ (0, O.jsxs)("tr", { children: [
						/* @__PURE__ */ (0, O.jsx)("th", {
							scope: "row",
							children: e.label
						}),
			...
			/* @__PURE__ */ (0, O.jsx)(j, {
				title: "Top Defects",
				count: e.topDefects.length,
				children: e.topDefects.length === 0 ? /* @__PURE__ */ (0, O.jsx)(A, {}) : /* @__PURE__ */ (0, O.jsx)(k, {
					caption: "Weekly Top Defects",
					headers: [
						"순위",
						"Line Shift",
						"Process Type",
					...
					children: e.topDefects.map((e, t) => /* @__PURE__ */ (0, O.jsxs)("tr", { children: [
						/* @__PURE__ */ (0, O.jsx)("td", {
							className: "numeric",
							children: e.rank
						}),
						/* @__PURE__ */ (0, O.jsx)("td", { children: e.lineShift ?? "-" }),
						/* @__PURE__ */ (0, O.jsx)("td", { children: e.processType }),
						/* @__PURE__ */ (0, O.jsx)("td", { children: e.processName }),
						/* @__PURE__ */ (0, O.jsx)("th", {
							scope: "row",
					...
					] }, `${e.rank}-${e.lineShift ?? "all"}-${e.processName}-${e.ngName}-${t}`))
				})
			})
		]
	});
...
//#endregion
//#region src/components/ReportTabContent.tsx
function Te({ report: e, tabKey: t, preferences: n }) {
	let r = e.tabs[t].status;
	if (r.state === "failed") return /* @__PURE__ */ (0, O.jsx)(Ee, { status: r });
	let i;
	switch (t) {
		case "daily": {
			let t = e.tabs.daily.data;
			i = t ? /* @__PURE__ */ (0, O.jsx)(ve, {
				data: t,
				preferences: n
			}) : /* @__PURE__ */ (0, O.jsx)(A, {});
			break;
		...
		case "weekly": {
			let t = e.tabs.weekly.data;
			i = t ? /* @__PURE__ */ (0, O.jsx)(we, {
				data: t,
				preferences: n
			}) : /* @__PURE__ */ (0, O.jsx)(A, {});
			break;
		...
		case "kpi": {
			let t = e.tabs.kpi.data;
			i = t ? /* @__PURE__ */ (0, O.jsx)(Ce, {
				data: t,
				preferences: n
			}) : /* @__PURE__ */ (0, O.jsx)(A, {});
			break;
		...
		case "cause-monthly": {
			let t = e.tabs["cause-monthly"].data;
			i = t ? /* @__PURE__ */ (0, O.jsx)(_e, {
				data: t,
				preferences: n
			}) : /* @__PURE__ */ (0, O.jsx)(A, {});
			break;
		...
		case "fcost": {
			let t = e.tabs.fcost.data;
			i = t ? /* @__PURE__ */ (0, O.jsx)(ye, {
				dataset: t.dataset,
				view: t.view,
				preferences: n
			}) : /* @__PURE__ */ (0, O.jsx)(A, {});
		...
		default: {
			let a = e.tabs[t].data, o = a ? ie(e, a) : null;
			i = a && o ? /* @__PURE__ */ (0, O.jsx)(ye, {
				dataset: o,
				view: a.view,
				preferences: n
			}) : /* @__PURE__ */ (0, O.jsx)(Ee, { status: {
				...r,
				message: "F-COST 원본 dataset을 찾을 수 없습니다."
			} });
			break;
		}
	}
	return /* @__PURE__ */ (0, O.jsxs)(O.Fragment, { children: [r.state === "partial" && /* @__PURE__ */ (0, O.jsx)(De, { status: r }), i] });
}
function Ee({ status: e }) {
	let t = e.errors.length > 0 ? e.errors.map((e) => e.message) : [e.message ?? "탭 데이터를 생성하지 못했습니다."];
	return /* @__PURE__ */ (0, O.jsxs)("div", {
		className: "state-card error-card",
		role: "alert",
		children: [
			/* @__PURE__ */ (0, O.jsx)("h2", { children: "탭을 표시할 수 없습니다" }),
			/* @__PURE__ */ (0, O.jsx)("ul", { children: t.map((e, t) => /* @__PURE__ */ (0, O.jsx)("li", { children: e }, `${t}-${e}`)) }),
			/* @__PURE__ */ (0, O.jsxs)("p", {
...
function De({ status: e }) {
	return /* @__PURE__ */ (0, O.jsxs)("aside", {
		...
		"aria-label": "부분 데이터 경고",
		children: [/* @__PURE__ */ (0, O.jsx)("strong", { children: e.message ?? "일부 데이터를 사용할 수 없습니다." }), e.warnings.length > 0 && /* @__PURE__ */ (0, O.jsx)("ul", { children: e.warnings.map((e, t) => /* @__PURE__ */ (0, O.jsx)("li", { children: e.message }, `${e.code}-${t}`)) })]
	});
}
//#endregion
//#region src/components/ViewerToolbar.tsx
function Oe({ preferences: e, defaults: t, onChange: n }) {
	let r = (t, r) => {
		let i = Number(r);
		n({
			...e,
			[t]: Number.isFinite(i) && i >= 0 ? i : 0
		});
	};
	return /* @__PURE__ */ (0, O.jsxs)("div", {
		className: "viewer-toolbar",
		"aria-label": "리포트 표시 필터",
		children: [
			/* @__PURE__ */ (0, O.jsxs)("label", { children: [/* @__PURE__ */ (0, O.jsx)("span", { children: "Minimum PPM" }), /* @__PURE__ */ (0, O.jsx)("input", {
				type: "number",
				min: "0",
				step: "100",
				value: e.minimumPpm,
				onChange: (e) => r("minimumPpm", e.currentTarget.value)
			})] }),
			/* @__PURE__ */ (0, O.jsxs)("fieldset", { children: [
				/* @__PURE__ */ (0, O.jsx)("legend", { children: "표시 기간" }),
				/* @__PURE__ */ (0, O.jsxs)("label", { children: [/* @__PURE__ */ (0, O.jsx)("span", { children: "일" }), /* @__PURE__ */ (0, O.jsx)("input", {
					type: "number",
					min: "0",
					step: "1",
					value: e.dateColumnLimit,
					onChange: (e) => r("dateColumnLimit", e.currentTarget.value)
				})] }),
				/* @__PURE__ */ (0, O.jsxs)("label", { children: [/* @__PURE__ */ (0, O.jsx)("span", { children: "주" }), /* @__PURE__ */ (0, O.jsx)("input", {
					type: "number",
					min: "0",
					step: "1",
					value: e.weekColumnLimit,
					onChange: (e) => r("weekColumnLimit", e.currentTarget.value)
				})] }),
				/* @__PURE__ */ (0, O.jsxs)("label", { children: [/* @__PURE__ */ (0, O.jsx)("span", { children: "월" }), /* @__PURE__ */ (0, O.jsx)("input", {
					type: "number",
					min: "0",
					step: "1",
					value: e.monthColumnLimit,
					onChange: (e) => r("monthColumnLimit", e.currentTarget.value)
				})] })
			] }),
...
//#endregion
//#region src/components/ReportShell.tsx
var ke = {
	daily: "Daily",
	weekly: "Weekly",
	kpi: "KPI",
...
function Ae({ report: e }) {
	let [t, n] = (0, l.useState)(() => C(e.viewerDefaults.defaultTab)), [r, i] = (0, l.useState)(() => b(e.viewerDefaults)), a = (0, l.useRef)([]), o = (0, l.useMemo)(() => e.request.groups.map((e) => e.name).join(", "), [e.request.groups]);
	(0, l.useEffect)(() => x(r), [r]);
	let s = (e) => {
		let t = (e + f.length) % f.length;
		n(f[t]), requestAnimationFrame(() => a.current[t]?.focus());
	}, c = (e, t) => {
		e.key === "ArrowRight" || e.key === "ArrowDown" ? (e.preventDefault(), s(t + 1)) : e.key === "ArrowLeft" || e.key === "ArrowUp" ? (e.preventDefault(), s(t - 1)) : e.key === "Home" ? (e.preventDefault(), s(0)) : e.key === "End" && (e.preventDefault(), s(f.length - 1));
	};
		...
		children: [
			/* @__PURE__ */ (0, O.jsxs)("header", {
				...
				children: [/* @__PURE__ */ (0, O.jsxs)("div", { children: [
					/* @__PURE__ */ (0, O.jsx)("p", {
						className: "eyebrow",
						children: "BMES INTEGRATED REPORT"
					}),
					/* @__PURE__ */ (0, O.jsx)("h1", { children: "BMES 통합 리포트" }),
					/* @__PURE__ */ (0, O.jsxs)("p", {
						className: "report-context",
						children: [
							/* @__PURE__ */ (0, O.jsx)("time", {
								dateTime: e.request.startDate,
								children: e.request.startDate
							}),
							...
							/* @__PURE__ */ (0, O.jsx)("time", {
								dateTime: e.request.endDate,
								children: e.request.endDate
							}),
							o && /* @__PURE__ */ (0, O.jsxs)(O.Fragment, { children: [" · ", o] })
						]
					})
				] }), /* @__PURE__ */ (0, O.jsxs)("dl", {
					className: "report-meta",
					children: [
						/* @__PURE__ */ (0, O.jsxs)("div", { children: [/* @__PURE__ */ (0, O.jsx)("dt", { children: "생성" }), /* @__PURE__ */ (0, O.jsx)("dd", { children: /* @__PURE__ */ (0, O.jsx)("time", {
							dateTime: e.generatedAtUtc,
							children: new Date(e.generatedAtUtc).toLocaleString("ko-KR", { timeZone: e.request.timeZoneId })
						}) })] }),
						/* @__PURE__ */ (0, O.jsxs)("div", { children: [/* @__PURE__ */ (0, O.jsx)("dt", { children: "계산" }), /* @__PURE__ */ (0, O.jsx)("dd", { children: e.calculationVersion })] }),
						/* @__PURE__ */ (0, O.jsxs)("div", { children: [/* @__PURE__ */ (0, O.jsx)("dt", { children: "Schema" }), /* @__PURE__ */ (0, O.jsx)("dd", { children: e.schemaVersion })] })
					]
				})]
			}),
			e.status.state !== "complete" && /* @__PURE__ */ (0, O.jsxs)("aside", {
				className: "root-status",
				role: e.status.state === "failed" ? "alert" : "status",
				children: [/* @__PURE__ */ (0, O.jsx)("strong", { children: e.status.message ?? "리포트에 경고가 있습니다." }), [...e.status.warnings, ...e.status.errors].length > 0 && /* @__PURE__ */ (0, O.jsx)("ul", { children: [...e.status.warnings, ...e.status.errors].map((e, t) => /* @__PURE__ */ (0, O.jsx)("li", { children: e.message }, `${e.code}-${t}`)) })]
			}),
			/* @__PURE__ */ (0, O.jsx)(Oe, {
				preferences: r,
				defaults: e.viewerDefaults,
				onChange: i
			}),
				...
				children: /* @__PURE__ */ (0, O.jsx)("div", {
					...
					children: f.map((r, i) => {
						...
						return /* @__PURE__ */ (0, O.jsxs)("button", {
							...
							onClick: () => n(r),
							onKeyDown: (e) => c(e, i),
							children: [ke[r], e.tabs[r].status.state !== "complete" && /* @__PURE__ */ (0, O.jsx)("span", {
								className: "status-dot",
								"aria-label": e.tabs[r].status.state
							})]
						}, r);
					})
				})
...
//#endregion
//#region src/App.tsx
function je({ reportUrl: e }) {
	let [t, n] = (0, l.useState)(0), [r, i] = (0, l.useState)({ kind: "loading" });
	return (0, l.useEffect)(() => {
		let t = new AbortController();
		return i({ kind: "loading" }), g(e, t.signal).then((e) => i({
			kind: "ready",
			report: e
		})).catch((e) => {
			if (e instanceof DOMException && e.name === "AbortError") return;
			let t = e instanceof p ? e : new p("network", "리포트를 불러오는 중 알 수 없는 오류가 발생했습니다.");
			i({
				kind: "error",
				error: t
			});
		}), () => t.abort();
	}, [e, t]), r.kind === "loading" ? /* @__PURE__ */ (0, O.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, O.jsx)("h1", { children: "BMES 리포트를 불러오는 중입니다" }),
			/* @__PURE__ */ (0, O.jsx)("p", { children: "데이터 크기에 따라 잠시 걸릴 수 있습니다." })
		]
	}) : r.kind === "error" ? /* @__PURE__ */ (0, O.jsx)(Me, {
		error: r.error,
		onRetry: () => n((e) => e + 1)
	}) : /* @__PURE__ */ (0, O.jsx)(Ae, { report: r.report });
}
function Me({ error: e, onRetry: t }) {
	let n = e.kind === "expired" ? "리포트 링크가 만료되었습니다" : e.kind === "unauthorized" ? "로그인이 필요합니다" : e.kind === "unsupported-schema" ? "뷰어 업데이트가 필요합니다" : "리포트를 표시할 수 없습니다";
	return /* @__PURE__ */ (0, O.jsxs)("main", {
		className: "center-state error-card",
		role: "alert",
		children: [
			/* @__PURE__ */ (0, O.jsx)("p", {
				className: "state-kicker",
				children: e.kind
			}),
			/* @__PURE__ */ (0, O.jsx)("h1", { children: n }),
...
function Pe(e, t = {}) {
	Fe(e);
	let n = t.reportUrl ?? e.dataset.reportUrl;
	if (!n) throw Error("BMES reportUrl is required.");
	let r = (0, u.createRoot)(e);
	return Ne.set(e, r), r.render(/* @__PURE__ */ (0, O.jsx)(je, { reportUrl: n })), () => Fe(e);
}
function Fe(e) {
	let t = Ne.get(e);
	t && (t.unmount(), Ne.delete(e));
}
//#endregion
export { Pe as mount, Fe as unmount };
