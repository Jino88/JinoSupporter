...
builder.Services.AddScoped<BmesDailyReportCalculationService>();
builder.Services.AddScoped<BmesCauseMonthlyCalculationService>();
builder.Services.AddScoped<BmesWeeklyReportCalculationService>();
