...
$stdoutPath = Join-Path $runRoot "benchmark-staged-b24-b25-v33.stdout.log"
$stderrPath = Join-Path $runRoot "benchmark-staged-b24-b25-v33.stderr.log"
$resultPath = Join-Path $runRoot "benchmark-staged-b24-b25-v33.result.json"
$exitPath = Join-Path $runRoot "benchmark-staged-b24-b25-v33.exit.json"
