...
$stdoutPath = Join-Path $runRoot "benchmark-staged-b24-b25-v30.stdout.log"
$stderrPath = Join-Path $runRoot "benchmark-staged-b24-b25-v30.stderr.log"
$resultPath = Join-Path $runRoot "benchmark-staged-b24-b25-v30.result.json"
$exitPath = Join-Path $runRoot "benchmark-staged-b24-b25-v30.exit.json"
...
$arguments = @(
    ...
    "--source-manifest", "pilot/corpus-benchmark-staged-b24-b25-v30.json",
