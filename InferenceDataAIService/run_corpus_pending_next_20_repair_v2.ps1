...
$stdoutPath = Join-Path $runRoot "pending-next-20-repair-v2.stdout.log"
$stderrPath = Join-Path $runRoot "pending-next-20-repair-v2.stderr.log"
...
$arguments = @(
    ...
    "--out", "outputs/corpus-ingest/full-989-v1/pending-next-20-repair-v2.result.json",
