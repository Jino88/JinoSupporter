...
$stdoutPath = Join-Path $runRoot "benchmark-staged-b14-formula-v34.stdout.log"
$stderrPath = Join-Path $runRoot "benchmark-staged-b14-formula-v34.stderr.log"
$resultPath = Join-Path $runRoot "benchmark-staged-b14-formula-v34.result.json"
$exitPath = Join-Path $runRoot "benchmark-staged-b14-formula-v34.exit.json"
...
$arguments = @(
    ...
    "--source-manifest", "pilot/corpus-benchmark-staged-b14-formula-v32.json",
