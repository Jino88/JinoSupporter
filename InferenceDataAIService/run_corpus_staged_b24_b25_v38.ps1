...
$stdoutPath = Join-Path $runRoot "benchmark-staged-b24-b25-v38.stdout.log"
$stderrPath = Join-Path $runRoot "benchmark-staged-b24-b25-v38.stderr.log"
$resultPath = Join-Path $runRoot "benchmark-staged-b24-b25-v38.result.json"
$exitPath = Join-Path $runRoot "benchmark-staged-b24-b25-v38.exit.json"
