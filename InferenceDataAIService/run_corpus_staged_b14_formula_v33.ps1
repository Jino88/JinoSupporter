...
$stdoutPath = Join-Path $runRoot "benchmark-staged-b14-formula-v33.stdout.log"
$stderrPath = Join-Path $runRoot "benchmark-staged-b14-formula-v33.stderr.log"
$resultPath = Join-Path $runRoot "benchmark-staged-b14-formula-v33.result.json"
$exitPath = Join-Path $runRoot "benchmark-staged-b14-formula-v33.exit.json"
