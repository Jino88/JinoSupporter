...
$stdoutPath = Join-Path $runRoot "benchmark-staged-b24-b25-v35.stdout.log"
$stderrPath = Join-Path $runRoot "benchmark-staged-b24-b25-v35.stderr.log"
$resultPath = Join-Path $runRoot "benchmark-staged-b24-b25-v35.result.json"
$exitPath = Join-Path $runRoot "benchmark-staged-b24-b25-v35.exit.json"
