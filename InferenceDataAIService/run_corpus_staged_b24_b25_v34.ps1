...
$stdoutPath = Join-Path $runRoot "benchmark-staged-b24-b25-v34.stdout.log"
$stderrPath = Join-Path $runRoot "benchmark-staged-b24-b25-v34.stderr.log"
$resultPath = Join-Path $runRoot "benchmark-staged-b24-b25-v34.result.json"
$exitPath = Join-Path $runRoot "benchmark-staged-b24-b25-v34.exit.json"
