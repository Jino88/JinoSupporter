...
$stdoutPath = Join-Path $serviceRoot "outputs\corpus-ingest\full-989-v1\benchmark-retry-10-v25.stdout.log"
$stderrPath = Join-Path $serviceRoot "outputs\corpus-ingest\full-989-v1\benchmark-retry-10-v25.stderr.log"
...
$arguments = @(
    ...
    "--source-manifest", "pilot/corpus-benchmark-retry-10-v25.json",
    "--journal", "outputs/corpus-ingest/full-989-v1/corpus-journal.json",
    "--out", "outputs/corpus-ingest/full-989-v1/benchmark-retry-10-v25.result.json",
