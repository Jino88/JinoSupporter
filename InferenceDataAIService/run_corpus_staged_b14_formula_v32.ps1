...
$stdoutPath = Join-Path $runRoot "benchmark-staged-b14-formula-v32.stdout.log"
$stderrPath = Join-Path $runRoot "benchmark-staged-b14-formula-v32.stderr.log"
$resultPath = Join-Path $runRoot "benchmark-staged-b14-formula-v32.result.json"
$exitPath = Join-Path $runRoot "benchmark-staged-b14-formula-v32.exit.json"
