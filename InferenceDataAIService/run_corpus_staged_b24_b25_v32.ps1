...
$stdoutPath = Join-Path $runRoot "benchmark-staged-b24-b25-v32.stdout.log"
$stderrPath = Join-Path $runRoot "benchmark-staged-b24-b25-v32.stderr.log"
$resultPath = Join-Path $runRoot "benchmark-staged-b24-b25-v32.result.json"
$exitPath = Join-Path $runRoot "benchmark-staged-b24-b25-v32.exit.json"
