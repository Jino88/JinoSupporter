...
$stdoutPath = Join-Path $runRoot "benchmark-staged-b24-b25-v36.stdout.log"
$stderrPath = Join-Path $runRoot "benchmark-staged-b24-b25-v36.stderr.log"
$resultPath = Join-Path $runRoot "benchmark-staged-b24-b25-v36.result.json"
$exitPath = Join-Path $runRoot "benchmark-staged-b24-b25-v36.exit.json"
