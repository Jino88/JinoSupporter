...
$stdoutPath = Join-Path $serviceRoot "outputs\corpus-ingest\full-989-v1\retry-b03-b05-v23.stdout.log"
$stderrPath = Join-Path $serviceRoot "outputs\corpus-ingest\full-989-v1\retry-b03-b05-v23.stderr.log"
...
$arguments = @(
    ...
    "--source-manifest", "pilot/corpus-semantic-retry-b03-b05-v23.json",
    "--journal", "outputs/corpus-ingest/full-989-v1/corpus-journal.json",
    "--out", "outputs/corpus-ingest/full-989-v1/retry-b03-b05-v23.result.json",
