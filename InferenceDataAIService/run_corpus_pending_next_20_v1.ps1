...
$stdoutPath = Join-Path $runRoot "pending-next-20-v1.stdout.log"
$stderrPath = Join-Path $runRoot "pending-next-20-v1.stderr.log"
...
$arguments = @(
    ...
    "--out", "outputs/corpus-ingest/full-989-v1/pending-next-20-v1.result.json",
