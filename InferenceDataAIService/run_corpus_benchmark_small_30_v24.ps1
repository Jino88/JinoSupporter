...
$stdoutPath = Join-Path $serviceRoot "outputs\corpus-ingest\full-989-v1\benchmark-small-30-v24.stdout.log"
$stderrPath = Join-Path $serviceRoot "outputs\corpus-ingest\full-989-v1\benchmark-small-30-v24.stderr.log"
...
$arguments = @(
    ...
    "--out", "outputs/corpus-ingest/full-989-v1/benchmark-small-30-v24.result.json",
