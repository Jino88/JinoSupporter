...
$stdoutPath = Join-Path $runRoot "benchmark-staged-b24-b25-v37.stdout.log"
$stderrPath = Join-Path $runRoot "benchmark-staged-b24-b25-v37.stderr.log"
$resultPath = Join-Path $runRoot "benchmark-staged-b24-b25-v37.result.json"
$exitPath = Join-Path $runRoot "benchmark-staged-b24-b25-v37.exit.json"
