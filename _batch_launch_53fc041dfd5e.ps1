...
$promptPath = 'D:\000. MyWorks\005. Program\Repository\JinoSupporter\_batch_prompt_53fc041dfd5e.txt'
$scriptPath = 'D:\000. MyWorks\005. Program\Repository\JinoSupporter\_batch_launch_53fc041dfd5e.ps1'
